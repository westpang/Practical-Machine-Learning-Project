...
Remove data that is near to zero which gives litle impact to the training and prediction
```{r echo=TRUE}
invalid <- nearZeroVar(training, saveMetrics=TRUE)
training <- training[,invalid$nzv==FALSE]

invalid<- nearZeroVar(testing,saveMetrics=TRUE)
testing <- testing[,invalid$nzv==FALSE]
```
